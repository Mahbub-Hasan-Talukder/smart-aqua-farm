...
extension TextThemeExtension on TextTheme {
  TextStyle get text3xlBold =>
      GoogleFonts.poppins(fontSize: 40, fontWeight: FontWeight.w900);
  TextStyle get text3xlSemiBold =>
      GoogleFonts.poppins(fontSize: 40, fontWeight: FontWeight.w700);
  TextStyle get text3xlMedium =>
      GoogleFonts.poppins(fontSize: 40, fontWeight: FontWeight.w500);
  TextStyle get text3xlRegular =>
  ...
  TextStyle get textBaseSemiBold =>
      GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w700);
  TextStyle get textBaseMedium =>
      GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w500);
  TextStyle get textBaseRegular =>
